...
export default function ExpenseDetails({expense}: ExpenseDetailsProps) {
    ...
    //son componentes especiales, por eso en vez de ser un arrowfunction va con ()
        ...
        >
            <div className="bg-white shadow-lg p-5 w-full border-b border-gray-200 flex gap-5 items-center">
                ...
                <div className="flex-1 space-y-2">
                    ...
                    <p className="text-slate-600 text-sm">{formatDate(expense.date!.toString())}</p> {/* Con el ! indicas que garantizas que ese valor va a existir */}
                </div>
                <AmountDisplay
